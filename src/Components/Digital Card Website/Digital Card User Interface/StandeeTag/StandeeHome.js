...
const StandeeHome = () => {
  ...
  return (
    ...
    <Grid item xs={12} sx={{backgroundColor:'#F3B419',borderBottomLeftRadius:'50%',borderBottomRightRadius:"50%",paddingBottom:10}}>
        ...
        <Grid item xs={12} sx={{display:"flex",justifyContent:'center'}}>
               <Button variant='contained' onClick={()=>navigate('/reviewsignup',{state:{tagId:id}})} sx={{fontSize:20 , backgroundColor:'#F3B419',color:"black", "&:hover":{backgroundColor:'#F3B419'}}}><Typography class='font'>Create New</Typography></Button> 
            </Grid>
