...
const DisplayAllDoorTagLink = () => {
  ...
  const matches=useMediaQuery(theme.breakpoints.down(700))
    ...
    const FetchAllCategory = async () => {
      var data = await getData("door/displayalltaglinks");
    ...
    const handleDelete=async(row)=>{
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            const response= await postData('door/deleteDoorTagLink',formData,true)
...
export default DisplayAllDoorTagLink
