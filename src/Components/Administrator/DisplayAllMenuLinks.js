...
const DisplayAllMenuLinks = () => {
  ...
  const matches=useMediaQuery(theme.breakpoints.down(700))
    ...
    const FetchAllCategory = async () => {
      var data = await getData("menulink/display");
    ...
    const handleDelete=async(row)=>{
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            const response= await postData('menulink/delete',formData,true)
...
export default DisplayAllMenuLinks
